...
<!DOCTYPE html> <!-- hosReservation.jsp -->
<html>
	<head>
	...
	<body>
		<header><h2>xx병원에 오신것을 환영합니다.</h2></header>
		<nav>
			<ul>
				<li></li>
				<li></li>
		...
		<fieldset class="fset"><legend>등록결과</legend>
			<% 
				int rec_no = dao.updateReservation(dto.getHos_id(), dto.getHos_passwd(), dto.getHos_subj(), dto.getSubj_time());
				if(rec_no > 0){
			%>
